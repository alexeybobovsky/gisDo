...
<SCRIPT src="/includes/JS/ga/logs.js" type=text/javascript></SCRIPT>
<script language="JavaScript">
{literal}
	$(document).ready(function(){
	$("table#logTable").tableSorter({
		...
		dateFormat: 'yyyy_mm_dd-hh:ii' // set date format for non iso dates default us, in this case override and set uk-format
	});
	});
