...
<TABLE cellSpacing=0 cellPadding=0 border=0 width='95%' >
  ...
  <TBODY>
  <TR><TD class="firm-info-title" colspan='10' valign='bottom' width='95%' >
  {$menu.lastTitle}
  </TD>
</TR>
...
{*<img src={$errorMsg.img} border = 0> &nbsp; &nbsp; *}
{/if} 
<TR><TD colspan='1' {*width='100%'*} style='padding-right: 15px;' align='left'>  
	...
	{assign var="SMRTcontentArea" value=$contentHTML[area]}	
		...
		<DIV class='form-standart'>
			...
			{/section}
			{if $content.elSubmit}
				{if $content.form.form_emptyCheck == '1'}
...
{if $helpString}
  <TD align='left' style='border-left: 1px #ccc solid; padding-left: 5px;' valign='top'><DIV class='help-message'>
	{$helpString}</DIV>
  </TD>
{else}
	<TD>&nbsp;</TD>
