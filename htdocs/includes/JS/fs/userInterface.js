...
/*	this.createFixedBlock = function(contName, fixedClass) 
		{
		var topPos = $(contName).offset().top; 
		$(window).scroll(function() 
			{ 
		var top = $(document).scrollTop();
		if (top > topPos) $(contName).addClass(fixedClass); 
		 else $(contName).removeClass(fixedClass);
			});	
		}*/
...
//		alert( showProperties(strArr1) + ' ' + strArr1.length + ' ' + strArr1[strArr1.length-2] + ' ' + strArr1[strArr1.length-1]);
//		alert( showProperties(strArr1));
//		alert( showProperties() str + ' - ' + strArr1.length);
...
//		alert ('map_changeTitle: ' + 'type = ' + type + ';  title = ' + title + '; num = ' + num)
		var addCity = '';
	...
	this.togglePanel = function (obj, contanerName, showModal, /*activatedClassName*/ userFunction)  
		{
//		alert(obj + ';  ' + contanerName + ';  ' + showModal + ';  ' + userFunction);
...
//				alert('document.documentElement.scrollTop  = ' + document.documentElement.scrollTop + innerHeight_ / 2 - width/2 + document.body.scrollTop)
...
/*			$(".fancybox-close").click(this.Keep);	*/
